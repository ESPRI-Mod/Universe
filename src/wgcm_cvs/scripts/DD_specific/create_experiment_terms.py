...
save_dir = 'data_descriptors/experiment/terms/'
...
for key, value in experiment_dict.items():
    experiment_data = {
        ...
        'additional_allowed_model_components': value['additional_allowed_model_components'],
        ...
        'required_model_components': value['required_model_components'],
        'start_year': value['start_year'],
        'sub_experiment_id': value['sub_experiment_id'],
        'tier': value['tier']
    }
